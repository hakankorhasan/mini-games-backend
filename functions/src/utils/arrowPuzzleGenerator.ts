...
export function getDifficultyConfig(level: number): DifficultyConfig {
    if (level <= 3) return {
        difficulty: "beginner", gridSize: 9,
    ...
    if (level <= 12) return {
        difficulty: "intermediate", gridSize: 15,
    ...
    if (level <= 27) return {
        difficulty: "advanced", gridSize: 20,
    ...
    if (level <= 250) return {
        difficulty: "grandmaster", gridSize: 33,
