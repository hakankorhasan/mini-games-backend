...
const LEVEL_TIERS: TierDef[] = [
    {
        ...
        difficultyRange: [1, 2],
        flowRange: [3, 4], deadRange: [1, 2],
        minPathMult: [0.5, 0.65],
    },
    {
        minLevel: 4, maxLevel: 7,
        gridSize: 5, difficulty: "easy",
        difficultyRange: [2, 3],
        flowRange: [4, 4], deadRange: [1, 2],
        minPathMult: [0.6, 0.7],
    },
    {
        minLevel: 8, maxLevel: 12,
        gridSize: 6, difficulty: "intermediate",
        difficultyRange: [3, 4],
        flowRange: [4, 5], deadRange: [2, 3],
        minPathMult: [0.6, 0.75],
    },
    {
        minLevel: 13, maxLevel: 17,
        gridSize: 6, difficulty: "medium",
        difficultyRange: [4, 5],
        flowRange: [5, 6], deadRange: [2, 4],
        minPathMult: [0.6, 0.75],
    },
    {
        minLevel: 18, maxLevel: 27,
        gridSize: 7, difficulty: "advanced",
        difficultyRange: [5, 6],
        flowRange: [5, 6], deadRange: [2, 5],
        minPathMult: [0.6, 0.75],
    },
    {
        minLevel: 28, maxLevel: 120,
    ...
    {
        minLevel: 121, maxLevel: 150,
        gridSize: 8, difficulty: "expert",
        difficultyRange: [7, 8],
        flowRange: [6, 8], deadRange: [4, 7],
        minPathMult: [0.65, 0.75],
    },
    {
        minLevel: 151, maxLevel: 200,
        gridSize: 9, difficulty: "master",
        difficultyRange: [8, 9],
        flowRange: [7, 9], deadRange: [5, 8],
        minPathMult: [0.65, 0.75],
    },
    {
        minLevel: 201, maxLevel: 250,
        gridSize: 10, difficulty: "grandmaster",
        difficultyRange: [9, 10],
        flowRange: [8, 10], deadRange: [6, 9],
        minPathMult: [0.6, 0.75],
    },
    {
        minLevel: 251, maxLevel: 300,
        gridSize: 11, difficulty: "legend",
        difficultyRange: [10, 11],
        flowRange: [9, 11], deadRange: [7, 10],
        minPathMult: [0.6, 0.7],
    },
    {
        minLevel: 301, maxLevel: 500,
        gridSize: 12, difficulty: "mythic",
